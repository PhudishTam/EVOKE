...
from dsets import (
    ...
    EVOKESubjSpecDataset
)
from experiments.py.eval_utils_counterfact import compute_rewrite_quality_counterfact
from experiments.py.eval_utils_evoke_main import compute_rewrite_quality_multihop, compute_rewrite_quality_evoke_main
from experiments.py.eval_utils_zsre import compute_rewrite_quality_zsre
from experiments.py.eval_utils_subj_spec import compute_rewrite_quality_subj_spec
...
DS_DICT = {
    ...
    "evoke-main": (EVOKEMainDataset, compute_rewrite_quality_evoke_main),
    "evoke-subj": (EVOKESubjSpecDataset, compute_rewrite_quality_counterfact),
}
...
def main(
    ...
    for chunk in chunks(ds, num_edits):
        record_chunks = chunk
        ...
        for record in record_chunks:
            ...
            metrics = {
                ...
                "time": exec_time,
                "portability": compute_rewrite_quality_subj_spec(
                    model=edited_model,
                    tok=tok,
                    record=record,
                ),
                "port_type": "subject_spec"
            }
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--ds_name",
        choices=["mcf", "cf", "zsre", "evoke-main", "evoke-subj"],
        default="evoke-subj",
